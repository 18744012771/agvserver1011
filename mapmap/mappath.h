...
class MapPath : public mapElement
{
public:
    enum Map_Path_Type{
        Map_Path_Type_Line = 0,//line
        Map_Path_Type_Quadratic_Bezier,//arc
        Map_Path_Type_Cubic_Bezier,//arc
       // Map_Path_Type_Between_Floor,//楼层间线路  not need
    };
    ...
    void setEnd(int _end) { end = _end; }//line
    void setP1x(int _p1x) { p1x = _p1x; }//arc
